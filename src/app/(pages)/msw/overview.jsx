    ...
    <Section>
      <div className="mx-auto md:w-2/3 md:text-center">
        <h2 className="text-3xl font-bold mb-6 text-gray-900 flex items-center justify-center gap-2">
          <span>What is MSW?</span>
        </h2>
        <p className="text-lg text-gray-700 mb-8">
           The MSW program is ideal for graduates who want to make a lasting impact. With advanced theory, research training, and field practice, this degree is a gateway to leadership in NGOs, government, CSR, and academia.
        </p>
      </div>
