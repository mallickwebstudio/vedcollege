      ...
      <Section>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="p-4 bg-green-100 border border-green-600 rounded-md overflow-hidden">
            ...
            <Link className={cn(buttonVariants({ variant: "outline" }), "mt-4 group")} href="/course/bsw">
              Explore BSW
          ...
          <div className="p-4 bg-green-100 border border-green-600 rounded-md overflow-hidden">
            ...
            <Link className={cn(buttonVariants({ variant: "outline" }), "mt-4 group")} href="/course/msw">
              Explore MSW
              <ArrowRight className="size-4 group-hover:ml-2 transition-all" />
            </Link>
          </div>
